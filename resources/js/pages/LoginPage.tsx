...
export default function LoginPage() {
  return <div className="min-h-screen w-full flex flex-col lg:grid lg:grid-cols-2 bg-[#121212] overflow-x-hidden">
    {/* Left Side - Cinematic Photo */}
    <div className="relative h-72 sm:h-96 lg:h-full w-full overflow-hidden group flex-shrink-0">
      <div className="absolute inset-0 bg-gradient-to-t from-[#121212] via-transparent to-transparent z-10 lg:bg-gradient-to-r lg:from-[#121212] lg:to-transparent" />
