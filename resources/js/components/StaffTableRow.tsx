...
export interface StaffMember {
  ...
  avatar?: string;
  email?: string; // Added for edit form
  pin?: string; // Added for edit form
}
...
export function StaffTableRow({
  ...
  return <tr className={`
    ...
    <td className="px-6 py-4">
      ...
      <button onClick={() => onDelete(staff.id)} className="p-2 text-white/40 hover:text-red-500 hover:bg-red-500/10 rounded-lg transition-colors ml-2">
        <Trash2 size={16} />
      </button>
    </td>
  </tr>;
