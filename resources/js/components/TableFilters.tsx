  ...
  return <div className="w-full bg-[#1A1A1A] border-b border-white/5 p-4 flex flex-col md:flex-row items-center justify-between gap-4 z-20 relative shadow-md">
    ...
    <div className="flex items-center gap-2 overflow-x-auto no-scrollbar w-full md:w-auto pb-2 md:pb-0">
      ...
      {onAddTable && (
        <button
          onClick={onAddTable}
          className="ml-2 px-4 py-2 rounded-lg text-sm font-medium bg-blue-600 hover:bg-blue-500 text-white flex items-center gap-2 transition-colors whitespace-nowrap"
        >
          <Plus size={16} />
          Add Table
        </button>
